                        ...
                        <Row>
                            <Col md={4} sm={12}>
                                <div className="Part 01">
                                    <Stack direction='vertical' gap={2}>
                                        <img src="https://futurristic.s3.amazonaws.com/image/icon/01-Service.png" alt="" className="img-fluid serviceIcon mx-auto" />
                                        {/* <img src="./image/icon/01-Service.png" alt="" className="img-fluid serviceIcon mx-auto" /> */}
                            ...
                            <Col md={4} sm={12}>
                                <div className="Part 02">
                                    <Stack direction='vertical' gap={2}>
                                        <img src="https://futurristic.s3.amazonaws.com/image/icon/02-Service.png" alt="" className="img-fluid serviceIcon mx-auto" />
                                        {/* <img src="./image/icon/02-Service.png" alt="" className="img-fluid serviceIcon mx-auto" /> */}
                            ...
                            <Col md={4} sm={12}>
                                <div className="Part 03">
                                    <Stack direction='vertical' gap={2}>
                                        <img src="https://futurristic.s3.amazonaws.com/image/icon/03-Service.png" alt="" className="img-fluid serviceIcon mx-auto" />
                                        {/* <img src="./image/icon/03-Service.png" alt="" className="img-fluid serviceIcon mx-auto" /> */}
                        ...
                        <Row className='mt-4'>
                            <Col md={4} sm={12}>
                                <div className="Part 04">
                                    <Stack direction='vertical' gap={2}>
                                        <img src="https://futurristic.s3.amazonaws.com/image/icon/04-Service.png" alt="" className="img-fluid serviceIcon mx-auto" />
                                        {/* <img src="./image/icon/04-Service.png" alt="" className="img-fluid serviceIcon mx-auto" /> */}
                            ...
                            <Col md={4} sm={12}>
                                <div className="Part 05">
                                    <Stack direction='vertical' gap={2}>
                                        <img src="https://futurristic.s3.amazonaws.com/image/icon/05-Service.png" alt="" className="img-fluid serviceIcon mx-auto" />
                                        {/* <img src="./image/icon/05-Service.png" alt="" className="img-fluid serviceIcon mx-auto" /> */}
                            ...
                            <Col md={4} sm={12}>
                                <div className="Part 06">
                                    <Stack direction='vertical' gap={2}>
                                        <img src="https://futurristic.s3.amazonaws.com/image/icon/06-Service.png" alt="" className="img-fluid serviceIcon mx-auto" />
                                        {/* <img src="./image/icon/06-Service.png" alt="" className="img-fluid serviceIcon mx-auto" /> */}
