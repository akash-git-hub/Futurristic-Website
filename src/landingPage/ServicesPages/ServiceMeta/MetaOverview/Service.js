                    ...
                    <Row className="mb-5">
                        <Col lg={4} sm={12} className='mb-5 animationcol'>
                            <div className="BenefitContentMeta">
                                ...
                                <div className='d-flex justify-content-center p-3'>
                                        ...
                                        </div> <h5 className=" text-center mb-2  fontWeight-800">Metaverse Consulting</h5>
                                    <p className=" p-3 text-justify text-grey-500">
                                    Reach your Metaverse goals faster and smarter with Futurristic’s strategic advice, technical know-how, and experience-based problem-solving approach  </p>
                                </div>
                            </div>
                        ...
                        <Col lg={4} sm={12} className='mb-5 animationcol'>
                            <div className="BenefitContentMeta">
                                ...
                                <div className='d-flex justify-content-center p-3'>
                                    ...
                                    </div><h5 className="mb-2 text-justify fontWeight-800 text-center">Metaverse Games</h5>
                                     
                                    <p className=" p-3 text-justify text-grey-500">
                                    Craft a captivating gaming world with Futurristic. Design and develop experiences that redefine entertainment & forge lasting connections within the metaverse. </p>
                                </div>
                            </div>
                            <div className='BenefitContentMetashadow'></div>
                        </Col>
                        <Col lg={4} sm={12} className='mb-5 animationcol'>
                            <div className="BenefitContentMeta">
                                ...
                                <div className='d-flex justify-content-center p-3'>
                                        ...
                                        </div>  <h5 className="mb-2 text-justify fontWeight-800 text-center">Metaverse Applications</h5>
                        ...
                        <Col lg={4} sm={12} className='mb-5 animationcol'>
                            <div className="BenefitContentMeta">
                                ...
                                </div>    <h5 className="mb-2 text-justify fontWeight-800 text-center">Simulations, Training, And Digital Twins</h5>        
                                <p className=" p-3 text-justify text-grey-500">
                        ...
                        <Col lg={4} sm={12} className='mb-5 animationcol'>
                            <div className="BenefitContentMeta">
                                ...
                                <div className='d-flex justify-content-center p-3'>
                                        ...
                                        </div>   <h5 className="mb-2 text-justify fontWeight-800 text-center">Metaverse Marketplaces</h5>
                        ...
                        <Col lg={4} sm={12} className='mb-5 animationcol'>
                            <div className="BenefitContentMeta">
                                ...
                                <div className='d-flex justify-content-center p-3'>
                                        ...
                                        </div>   <h5 className=" mb-2 text-justify fontWeight-800 text-center">Metaverse Integration Services</h5>
                        ...
                        <Col lg={4} sm={12} className='mb-5 animationcol'>
                            <div className="BenefitContentMeta">
                                ...
                                <div className='d-flex justify-content-center p-3'>
                                        ...
                                        </div>  <h5 className="mb-2 text-justify fontWeight-800 text-center">Metaverse For Enterprise</h5>
                                    <p className="text-justify text-grey-500">
