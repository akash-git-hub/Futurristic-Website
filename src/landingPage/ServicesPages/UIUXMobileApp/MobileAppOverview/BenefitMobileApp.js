                    ...
                    <Col>
                        <div className="BenefitContent">
                            ...
                            <div className="vstack gap-1">
                                <h5 className="mb-2 fontWeight-500">Enhanced Security and Trust</h5>
                            </div>
                        </div>
                    </Col>
                    <Col>
                        <div className="BenefitContent">
                            ...
                            <div className="vstack gap-1">
                                <h5 className="mb-2 fontWeight-500">Improved Efficiency and Cost Reduction</h5>
                            </div>
                        </div>
                    </Col>
                    <Col>
                        <div className="BenefitContent">
                            ...
                            <div className="vstack gap-1">
                                <h5 className="mb-2 fontWeight-500">Greater Transparency</h5>
                            </div>
                        </div>
                    </Col>
                    <Col>
                        <div className="BenefitContent">
                            ...
                            <div className="vstack gap-1">
                                <h5 className="mb-2">Innovation and Competitive Edge</h5>
                            </div>
                        </div>
                    </Col>
                    <Col>
                        <div className="BenefitContent">
                            ...
                            <div className="vstack gap-1">
                                <h5 className="mb-2">Decentralization Benefits</h5>
                            </div>
                        </div>
                    </Col>
                    <Col>
                        <div className="BenefitContent">
                            ...
                            <div className="vstack gap-1">
                                <h5 className="mb-2">Data Integrity and Traceability</h5>
                            </div>
                        </div>
                    </Col>
                </Row>
