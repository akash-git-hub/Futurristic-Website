...
function App() {
  ...
  const WebARServicesWithMeta = () => (
    <>
      <RouteSpecificMeta title="Web AR-Based Marketing Solutions | Web Based AR" description="Elevate your marketing efforts with WebAR development. Launch effective Web-based AR campaigns. Achieve more with our WebAR marketing/business solutions!" />
      <WebARServices />
    </>
  );
